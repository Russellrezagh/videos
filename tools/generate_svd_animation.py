diff --git a//dev/null b/tools/generate_svd_animation.py
index 0000000000000000000000000000000000000000..a6605ebca5d223365ca92f65b70b8b925748cf82 100644
--- a//dev/null
+++ b/tools/generate_svd_animation.py
@@ -0,0 +1,266 @@
+#!/usr/bin/env python3
