...
class SVDAnimator:
    def __init__(self, matrix: np.ndarray, total_frames: int):
        self.matrix = matrix
    ...
    def animate(self, fps: int, output: Path) -> None:
        ...
        animation_obj.save(output, writer=writer, dpi=120)
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    animator = SVDAnimator(matrix, total_frames)
    try:
        animator.animate(args.fps, args.output)
